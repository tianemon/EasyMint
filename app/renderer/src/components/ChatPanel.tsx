  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 bg-surface shrink-0">
        ...
        <select value={permissionMode} onChange={(e) => setPermissionMode(e.target.value)} className="text-[11px] px-2 py-1 rounded-md bg-surface border border-border text-text-primary outline-none focus:border-input-focus cursor-pointer">
        ...
        <select value={chatModel || storeModel} onChange={(e) => handleModelChange(e.target.value)} className="text-[11px] px-2 py-1 rounded-md bg-surface border border-border text-text-primary outline-none focus:border-input-focus cursor-pointer max-w-[200px]" title="切换模型">
      ...
      <div className="border-t border-border p-3 pt-2 shrink-0">
        ...
        <div className="flex gap-2 items-end">
          <textarea
            ...
            rows={3}
            className="flex-1 min-h-[90px] resize-none bg-surface border border-border rounded-[10px] px-[14px] py-[10px] text-[13px] text-text-primary placeholder-text-secondary focus:outline-none focus:border-input-focus"
          />
          {(loading || streaming) ? (
