  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 bg-surface shrink-0">
        ...
        {balanceText && <span className="text-[10px] text-text-secondary cursor-pointer hover:text-accent transition-colors" onClick={refreshBalance} data-tip="账户余额，点击刷新">{balanceText}</span>}
        <span className="text-[10px] text-text-secondary" data-tip="上下文使用率，可设置阈值">{ctxPct}%</span>
      </div>
