...
export function ScriptEditDialog({ projectPath, runnable, runnables, onClose }: ScriptEditDialogProps): JSX.Element | null {
  ...
  return (
    <Modal overlayClassName="bg-black/40" onClose={onClose}>
      <div className="relative bg-[var(--modal-fill)] rounded-[var(--radius-lg)] border border-border shadow-2xl w-[760px] h-[600px] flex flex-col overflow-hidden">        <div className="flex items-center justify-between px-4 py-1.5 shrink-0">
