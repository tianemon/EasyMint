...
export function ModelManager({
  ...
  return (
    <div>
      <label className="text-xs text-text-secondary block mb-1.5">模型管理<span className="text-[length:var(--text-2xs)] text-text-muted">（添加自定义模型，或调整官方模型的窗口、输出等参数）</span></label>
