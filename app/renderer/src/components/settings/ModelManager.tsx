  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          className="shrink-0 h-8 px-3 rounded-[var(--radius-btn)] border border-border text-text-secondary text-xs hover:bg-surface-hover transition-colors"
          onClick={addModel}
        >添加</button>
      </div>
      ...
      {draft && (
        <div className="rounded-[var(--radius-control)] bg-surface border border-border px-2.5 py-2 space-y-2">
          ...
          <div className="flex items-center justify-between">
            <button
              type="button"
              className="h-7 px-3 rounded-[var(--radius-btn)] border border-danger-border text-danger text-xs hover:bg-danger-soft transition-colors"
              onClick={deleteModel}
            >删除</button>
            <div className="flex gap-2">
              <button
                type="button"
                className="h-7 px-3 rounded-[var(--radius-btn)] border border-border text-text-secondary text-xs hover:bg-surface-hover transition-colors"
                onClick={closeEdit}
              >取消</button>
              <button
                type="button"
                className="h-7 px-3 rounded-[var(--radius-btn)] btn-accent text-xs font-medium"
                onClick={saveDraft}
              >保存</button>
            </div>
          </div>
