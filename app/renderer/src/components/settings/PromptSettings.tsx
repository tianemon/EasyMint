      ...
      <div className="flex gap-3" style={{ minHeight: 260 }}>
        ...
        {selectedPrompt && (
          <div className="flex-1 flex flex-col gap-2 min-w-0">
            <input
              className="w-full px-3 py-1.5 text-sm rounded-lg bg-surface border border-border text-text-primary outline-none focus:border-input-focus disabled:opacity-50"
              value={editName}
            ...
            />
            <textarea
              className="flex-1 w-full resize-none px-3 py-2 text-sm rounded-lg bg-surface border border-border text-text-primary outline-none focus:border-input-focus disabled:opacity-50 font-mono"
              value={editContent}
