          ...
          <div className="divide-y divide-border flex-1 overflow-y-auto">
            {config.prompts.map((prompt) => (
              ...
              >
                ...
                {prompt.isBuiltin && <span className="text-[length:var(--text-2xs)] text-text-secondary shrink-0">内置</span>}
                ...
                {hoveredId === prompt.id && !prompt.isBuiltin && (
                  <button
                    className="text-[length:var(--text-2xs)] text-text-secondary hover:text-danger shrink-0"
