      ...
      >
        ...
        <div className="space-y-2">
          <button
            type="button"
            onClick={onImmediate}
            className="w-full text-left px-3 py-2 rounded-lg bg-surface-alt hover:bg-surface-hover border border-border text-xs text-text-primary transition-colors"
          >
            是，立即压缩（系统自动总结）
          </button>
          <div className="flex items-center gap-2">
            <input
              ...
              autoFocus
              className="flex-1 min-w-0 px-2.5 py-1.5 rounded-lg bg-surface-alt border border-border text-xs text-text-primary outline-none placeholder:text-text-muted focus:border-accent"
            />
            <button
              type="button"
