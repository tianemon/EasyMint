          ...
          {currentStep === 0 && (
            <div className="space-y-4">
              <div>
                ...
                <input
                  className="w-full px-3 py-2.5 rounded-lg bg-surface border border-border text-text-primary text-sm outline-none focus:border-input-focus"
                  value={baseUrl}
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    className="flex-1 px-3 py-2.5 rounded-lg bg-surface border border-border text-text-primary text-sm outline-none focus:border-input-focus font-mono"
