      ...
      <div id="app-shell">
        ...
        {migrateDone && (
          <div className="no-drag fixed inset-0 z-dialog bg-black/40 flex items-center justify-center modal-overlay" onMouseDown={() => setMigrateDone(null)}>
            <div className="bg-[var(--modal-fill)] rounded-[var(--radius-lg)] border border-border shadow-2xl modal-card flex flex-col" style={{ width: 520, maxHeight: "85vh" }} onMouseDown={(e) => e.stopPropagation()}>
