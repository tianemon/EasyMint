...
const getMCPConfigPath = () => require("node:path").join(require("node:os").homedir(), ".claude", ".claude.json"); // was @oh-my-pi/pi-utils
import { mcpCapability } from "./stubs";
import type { SourceMeta } from "./stubs";
import type { MCPServer } from "./stubs";
import { loadCapability } from "./stubs";
