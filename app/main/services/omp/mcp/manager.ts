...
const isDefinitiveOAuthFailure = (e: unknown): boolean => false; // was @oh-my-pi/pi-ai
type TSchema = object;
const logger = { warn: (...a: any[]) => {}, error: (...a: any[]) => {}, debug: (...a: any[]) => {}, info: (...a: any[]) => {} }; // was @oh-my-pi/pi-utils
type SourceMeta = { name?: string; path?: string };
const resolveConfigValue = (v: any) => v; // stub
import type { CustomTool } from "./stubs";
