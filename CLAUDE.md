...
| 了解当前进度 | `docs/开发进度.md` | 进度唯一真相源——头部快照=当前版本/最近工作/接下来安排，下方=实现详录 |
...
> **规则**：进度与交接的实际内容记录在 `docs/开发进度.md` 头部「当前进度快照」——会话结束时更新该快照（当前版本 / 最近工作 / 接下来安排）。**本区只做指引，不写进度内容**。
...
| `docs/开发进度.md` | **进度唯一真相源**——头部「当前进度快照」= 当前版本/最近工作/接下来安排；下方章节 = 功能实现详录 |
| `docs/待办事项.md` | 未实施/缓做清单（含已暂停项） |
